...
export const Features: React.FC<FeaturesProps> = ({ onSelectFeature, onOpenAuth }) => {
  ...
  return (
    <section id="features" className="py-24 relative bg-zinc-950 overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-emerald-700/10 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-950/80 border border-emerald-500/30 text-emerald-300 text-xs font-bold mb-4"
          >
            ...
            return (
              <motion.div
                ...
                className={`cursor-pointer rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between relative ${
                  isSelected
                    ? 'bg-zinc-900 border-2 border-emerald-500 shadow-xl shadow-emerald-950/80'
                    : 'glass-card glass-card-hover hover:border-emerald-500/40'
                }`}
              >
                {/* Badge Tag */}
                <div className="flex items-center justify-between mb-4">
                  <div className="p-3 rounded-xl bg-zinc-950 border border-emerald-500/30 shadow-inner">
                ...
                <div className="pt-4 border-t border-emerald-950 flex items-center justify-between text-xs font-bold text-emerald-400 group">
        ...
        <motion.div
          ...
          className="glass-card rounded-2xl border border-emerald-500/40 p-6 sm:p-8 bg-zinc-950 relative overflow-hidden shadow-2xl"
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-4">
              ...
              <div className="pt-4 flex flex-wrap items-center gap-4">
                <button
                  onClick={onOpenAuth}
                  className="px-6 py-3 rounded-xl text-xs font-extrabold text-black bg-emerald-400 hover:bg-emerald-300 shadow-lg shadow-emerald-500/30 transition-all flex items-center gap-2"
                >
                ...
                <a
                  href="#playground"
                  className="text-xs font-semibold text-slate-300 hover:text-emerald-400 underline underline-offset-4"
                >
            ...
            <div className="lg:col-span-5 bg-zinc-900 p-6 rounded-xl border border-emerald-500/30 shadow-inner flex flex-col justify-center space-y-4">
              <div className="flex items-center justify-between text-xs text-slate-400 pb-2 border-b border-emerald-950">
                <span className="font-mono text-emerald-400 font-bold">STUDYMIND AI PERFORMANCE</span>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-zinc-950 p-3 rounded-lg border border-emerald-500/20">
                  <div className="flex justify-between text-xs mb-1">
                    ...
                    <span className="text-emerald-300 font-bold">14.5 Hours</span>
                  </div>
                  <div className="w-full bg-zinc-900 h-2 rounded-full overflow-hidden">
                    <div className="bg-emerald-300 h-full w-[88%]" />
                  </div>
                </div>
              </div>
            </div>
